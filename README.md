...
- **Cross-tool** — Claude Desktop, ChatGPT Desktop, Cursor, Gemini CLI, any MCP
  client
...
- **Human-readable** — YAML files in `~/.aura/packs/`, git-friendly, fully
  editable
...
- **Pack templates** — create domain-specific starter packs (frontend,
  data-scientist, devops, writer)
